class matrix:
    ...
    def __init__(self,w_vertex,w_edge):
        self.Similarity_matrix_edge = {'method': {}, 'implements': {}, 'contains': {}, 'extends': {}}
        ...
        self.Similarity_matrix_edge['method']['implements'] = w_vertex[4]
        self.Similarity_matrix_edge['method']['contains'] = w_vertex[5]
        self.Similarity_matrix_edge['method']['extends'] = w_vertex[6]

        self.Similarity_matrix_edge['implements']['method'] = w_vertex[7]
        self.Similarity_matrix_edge['implements']['contains'] = w_vertex[8]
        self.Similarity_matrix_edge['implements']['extends'] = w_vertex[9]

        self.Similarity_matrix_edge['contains']['method'] = w_vertex[10]
        self.Similarity_matrix_edge['contains']['implements'] = w_vertex[11]
        self.Similarity_matrix_edge['contains']['extends'] = w_vertex[12]

        self.Similarity_matrix_edge['extends']['method'] = w_vertex[13]
        self.Similarity_matrix_edge['extends']['implements'] = w_vertex[14]
        self.Similarity_matrix_edge['extends']['contains'] = w_vertex[15]

        self.Similarity_matrix_class = {'project': {}, 'method': {}, 'class': {}}
        ...
        self.Similarity_matrix_class['project']['method'] = w_edge[3]
        self.Similarity_matrix_class['method']['project'] = w_edge[4]
        self.Similarity_matrix_class['project']['class'] = w_edge[5]
        self.Similarity_matrix_class['class']['project'] = w_edge[6]
        self.Similarity_matrix_class['method']['class'] = w_edge[7]
        self.Similarity_matrix_class['class']['method'] = w_edge[8]
